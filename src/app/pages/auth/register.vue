		...
		<div class="flex flex-row justify-end">
			...
			<div class="flex flex-row items-center lg:px-8 w-full min-h-svh sm:w-1/2 md:w-2/5 xl:w-2/6 bg-white dark:bg-black">
				<form class="w-full px-6 py-4" @submit="submitForm">
					...
					<label class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ t('register.email') }}</label>
					<div class="mt-1 mb-4">
						<Input
					...
					<label class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ t('register.password') }}</label>
					<div class="mt-1 mb-4">
						<Input
					...
					<label class="block text-sm font-medium text-gray-700 dark:text-gray-200">{{ t('register.repeat_password') }}</label>
					<div class="mt-1 mb-4">
						<Input
					...
					<div class="mt-1.5">
						<span class="text-sm mr-1 dark:text-gray-200">{{ t('register.question') }}</span>
